    ...
    public static HouseState toEntity(String message) {
        ...
        HouseState houseState = HouseState.builder()
            ...
            .temperatures(List.of(
                Temp.builder().measurePlace(LIVING_ROOM).temperature(values.get("livRoomT")).rh(values.get("livRoomRh")).ah(values.get("livRoomAh")).build(),
                Temp.builder().measurePlace(TERRACE).temperature(values.get("roofT")).rh(values.get("roofRh")).ah(values.get("roofAh")).build(),
                Temp.builder().measurePlace(TERRACE_WINDOW).temperature(values.get("windT")).rh(values.get("windRh")).ah(values.get("windAh")).build()
            ))
            .aqis(List.of(
